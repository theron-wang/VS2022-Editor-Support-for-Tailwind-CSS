...
namespace TailwindCSSIntellisense
{
    internal sealed partial class Vsix
    {
        ...
        public const string Description = @"Unofficial VS2022 extension for Tailwind CSS, offering editor features such as IntelliSense, linting, build shortcuts, and more.";
