...
{
    /// <summary>
    /// Completion provider for all CSHTML content files to provide Intellisense support for TailwindCSS classes
    /// </summary>
    internal class CshtmlCompletionSource : ICompletionSource
    {
        ...
        public CshtmlCompletionSource(CompletionUtilities completionUtils, SettingsProvider settingsProvider, ITextBuffer textBuffer)
        {
