...
namespace TailwindCSSIntellisense.Completions.Controllers
{
    ...
    internal sealed class CshtmlCompletionController : IVsTextViewCreationListener
    {
        [Import]
        ...
        public void VsTextViewCreated(IVsTextView textViewAdapter)
        {
            ...
            var filter = new CshtmlCommandFilter(view, CompletionBroker);
    ...
    internal sealed class CshtmlCommandFilter : IOleCommandTarget
    {
        ICompletionSession _currentSession;

        public CshtmlCommandFilter(IWpfTextView textView, ICompletionBroker broker)
        {
